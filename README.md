...
3. Prediction of Urban Water Quality using Ubiquitous Data 
• Led a 4-member team to develop machine learning models in Python to predict urban water quality trends.

• Achieved 85% prediction accuracy on test data, enabling timely interventions for water safety. 

• Generated actionable insights that helped identify key contamination sources and optimize monitoring 
schedules. 


5. Premium Billing Accuracy and Policy Data Synchronization 
...
6. Predictive Analytics for Project Timelines 
